...
Meteor.startup(function() {
  if (Meteor.isServer && Activities.find().count() === 0) {
    Activities.insert({
      recipeName: 'fisker-mustang',
      text: 'This is definitely a huge upgrade from my previous car - Mindblown!',
      image: '/img/activity/fisker-mustang.jpg',
      userAvatar: 'https://avatars3.githubusercontent.com/u/12537973?v=3&s=400',
      userName: 'Albert Manuel',
